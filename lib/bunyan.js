...
function Logger(options, _childOptions, _childSimple) {
  ...
  if (options.postExecute && typeof(options.postExecute) !== 'function') {
    throw new TypeError('invalid options.postExecute: must be a function');
  }
...
Logger.prototype.log = mkLogEmitter(INFO);
